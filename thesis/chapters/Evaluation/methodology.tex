...
Unlike to the other tasks, this workbook contained 3 worksheets with pricing analysis, product catalogue and supplier costs. This tasks goal was to test the comprehension when multiple workbooks are involved.
...
The study used the User Experience Questionnaire Plus and the participants had to answer it after they completed all three tasks. The questionnaire consisted of seven scales, Usefulness, Dependability, Efficiency, Perspicuity, Clarity, Intuitive and Visual Aesthetics. Each of these scales had four items on a seven-point Likert scale (1=most negative pole; 7=most positive pole).
