...
Unlike the other tasks, this workbook contained 3 worksheets with pricing analysis, product catalogue and supplier costs. This task's goal was to test the comprehension when multiple workbooks are involved.
