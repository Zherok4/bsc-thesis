...
HyperFormula recognizes five basic cell value types: numbers, booleans, dates, strings and empty cells. Dates are stored internally as a numeric representation rather than as date objects \cite{noauthor_hyperformula_nodate}.
